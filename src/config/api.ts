...
export const ApiKey: string = import.meta.env.VITE_MARVEL_API_KEY as string;
const ApiPrivateKey: string = import.meta.env
  .VITE_MARVEL_API_PRIVATE_KEY as string;
